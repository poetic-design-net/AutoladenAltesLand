...
The original reference is `Downloads/ChatGPT Image 4. Sept. 2026, 10_11_53.png`; the user-approved alternative image is `Downloads/ChatGPT Image 4. Sept. 2026, 10_18_54.png`. Its generated scene is illustrative, not a customer photograph. Four original installation photos plus one user-supplied manufacturer award image form a small horizontal gallery with an accessible enlarged view. The ntv/DISQ award was verified for Naturbummler at https://disq.de/qualitaets-sieger.html on 2026-09-04. It is attributed to the manufacturer, not Alex, and is not a TÜV certification or partnership claim. The award image uses contain rather than crop; a CMS-managed note links to the primary source.
...
The additional award photo/note uses `node studio/sync-rooftent-award.mjs [--apply]`: additive, backed up and revision guarded; no replacement of existing gallery images. The nature eyebrow is “Raus in die Natur.” in both Sanity and defaults.
